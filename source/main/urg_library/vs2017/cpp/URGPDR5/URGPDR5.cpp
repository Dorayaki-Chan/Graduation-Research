...
#define ESPIPADDR  "10.84.233.124" //"192.168.11.18"//192.168.208.233, 
#define BUTTON_ID1 0
...
#define LOG_PATH "Matsu-log-20230422-1.txt"
...
int myTXTout() {
    ...
    hFile = CreateFile(TEXT(LOG_PATH), GENERIC_READ | GENERIC_WRITE, 0, NULL,
