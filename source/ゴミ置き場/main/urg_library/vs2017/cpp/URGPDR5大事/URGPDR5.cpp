...
#define ESPIPADDR  "192.168.186.233"//"192.168.11.18"//192.168.208.233, 
#define BUTTON_ID1 0
...
int myTXTout() {
    ...
    hFile = CreateFile(TEXT("test1107-1.txt"), GENERIC_READ | GENERIC_WRITE, 0, NULL,
...
int MyPaint(HWND hwnd) {//描画は全部ここ
    ...
    hFile = CreateFile(TEXT("test1108-3.txt"), GENERIC_READ | GENERIC_WRITE, 0, NULL,
        OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
    if (hFile == INVALID_HANDLE_VALUE) {
        //MessageBox(NULL, TEXT("ファイルが開けません"), NULL, MB_OK);
    }
