...
#include "urg_connection.h"
    ...
    */
    typedef enum {
        ...
        URG_DISTANCE_IO,           //!<  Distance (range) and IO(input/output)
        URG_DISTANCE_INTENSITY_IO, //!<  Distance (range), intensity and IO(input/output)
    ...
    */
    ...
    enum {
        ...
        URG_MAX_IO = 2,         //!<  Maximum number of IO(input/output)
    };
